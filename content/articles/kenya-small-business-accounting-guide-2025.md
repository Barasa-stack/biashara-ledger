...
- **Income Tax** — Annual returns due by June 30th. The standard corporate rate is 30%, while turnover tax (3% on gross sales up to KES 50 million) applies to many SMEs.
- **VAT** — Monthly filing required if annual turnover exceeds KES 8 million. Standard rate is 16%, with select goods and services at 8% or zero-rated.
- **PAYE** — Monthly payroll deductions filed by the 9th of the following month. Late filing attracts a 25% penalty plus 2% monthly interest.
...
- **KRA-compliant reporting** — VAT, income tax, and PAYE reports that meet iTax requirements
- **M-Pesa integration** — automatic transaction matching
- **Multi-currency support** — essential for importing goods or serving clients across borders
