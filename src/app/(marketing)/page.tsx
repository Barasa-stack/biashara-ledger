...
// MULTIPLE skyscraper images for the carousel
  ...
  return (
    <div>
      ...
      <PageHero
        ...
        subtitle="BiasharaLedger is the all-in-one platform for businesses worldwide — inventory, sales, accounting, payroll, and reporting designed for your needs."
        badge="Welcome"
        badgeWithoutTrust
      />

      {/* ─── STATS ─── */}
      <section className="py-16 bg-gradient-to-b from-brand/5 to-white" aria-labelledby="stats-heading">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-brand/5 border border-brand/10 rounded-full px-4 py-1.5 mb-4 animate-on-scroll">
              <span className="text-xs font-semibold text-brand">Features</span>
            </div>
