...
export async function POST(req: NextRequest) {
  try {
    ...
    await adminRun(
      `INSERT INTO users (tenant_id, email, password_hash, first_name, last_name, phone, country, role, verified,
        subscription_plan, subscription_status, subscription_expiry, license_key, license_status)
       VALUES ($1, $2, $3, $4, $5, $6, $7, 'user', 1, 'trial', 'trial', $8, $9, 'trial')`,
      [tenantUuid, normalizedEmail, hashedPassword, firstName || '', lastName || '', phone || '', country || 'KE', trialExpiry, trialKey]
    );
