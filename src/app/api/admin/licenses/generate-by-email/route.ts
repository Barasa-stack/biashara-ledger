...
export async function POST(req: Request) {
  try {
    ...
    // Generate temp password for first login
          ...
          html: `
            <div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;">
              ...
              <div style="padding:28px;background:#fff;border:1px solid #e5e7eb;">
                ...
                <p style="font-size:13px;color:#888;margin-top:16px;">Use the "Forgot Password" link on the sign-in page if you need to reset your password.</p>
              </div>
